...
const routes = [
  ...
  { path: "/orders/orders-table?steps=FirstStep", name: "OrdersTable", component: OrdersTable },
  { path: "/orders/orders-table?steps=SecondStep", name: "OrdersTable", component: OrdersTable },
  { path: "/orders/orders-table?steps=ThirdStep", name: "OrdersTable", component: OrdersTable },
